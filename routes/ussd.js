...
4. Unsafe road`;
      ...
      await createAlert({ location, category, description: `Reported via USSD by ${phoneNumber}`, reporterPhone: phoneNumber, source: 'ussd' });
...
NaijaSafe Travel OS.`;
    ...
    console.error('[NaijaSafe] /ussd error (server kept alive):', err.message);
